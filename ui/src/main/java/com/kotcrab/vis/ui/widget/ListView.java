...
public class ListView<ItemT> {
    private final ListAdapter<ItemT> adapter;
    ...
    private final ListViewTable<ItemT> mainTable;
    private final VisScrollPane scrollPane;

    private final VisTable scrollTable;
    private final VisTable itemsTable;
    ...
    public static class ListViewTable<ItemT> extends VisTable {
        private final ListView<ItemT> listView;
