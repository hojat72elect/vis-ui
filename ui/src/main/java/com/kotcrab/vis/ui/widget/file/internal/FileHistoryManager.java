...
import static com.kotcrab.vis.ui.widget.file.internal.FileChooserText.BACK;
import static com.kotcrab.vis.ui.widget.file.internal.FileChooserText.DIRECTORY_NO_LONGER_EXISTS;
import static com.kotcrab.vis.ui.widget.file.internal.FileChooserText.FORWARD;
...
public class FileHistoryManager {
    ...
    private final Array<FileHandle> history = new Array<FileHandle>();
    private final Array<FileHandle> historyForward = new Array<FileHandle>();

    private final VisTable buttonsTable;
    private final VisImageButton backButton;
    private final VisImageButton forwardButton;
