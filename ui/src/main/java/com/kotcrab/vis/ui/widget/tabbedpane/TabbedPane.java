...
public class TabbedPane {
    ...
    private final TabbedPaneTable mainTable;

    private final Array<Tab> tabs;
    private final IdentityMap<Tab, TabButtonTable> tabsButtonMap;
        ...
        if (style.draggable) {
            ...
            draggable.setListener(new DragPane.DefaultDragListener() {
                ...
                public boolean onEnd(Draggable draggable, Actor actor, float stageX, float stageY) {
                    ...
                    if (!tmpRect.contains(stageX, stageY)) return CANCEL;
    ...
    private class TabButtonTable extends VisTable {
        ...
        private final VisTextButtonStyle buttonStyle;
        ...
        private void addListeners() {
            ...
            button.addListener(new InputListener() {
                ...
                public void enter(InputEvent event, float x, float y, int pointer, Actor fromActor) {
                    if (!button.isDisabled() && activeTab != tab && !Gdx.input.justTouched() && pointer == -1) {
                        setCloseButtonOnMouseMove();
                    }
                }
